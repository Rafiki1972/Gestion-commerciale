...
import CheckCookie, { setCookie, getCookie } from './cookie';

export const NavBar = () => {
    // dark mode
    const changeDarkmode = () => {
        // toggleDarkMode((prevDarkMode: Boolean) => !prevDarkMode); // Toggle the state value
        // const currentDarkModeValue = getCookie('darkMode') === 'true'; // Convert string to boolean

        // // Toggle the value and set the updated cookie
        // setCookie('darkMode', !currentDarkModeValue);
    ...
    return (
        <aside
            id="sidebar"
            className='fixed z-20 h-full top-1 left-1 flex lg:flex flex-shrink-0 fle-col lg:w-64 transition-all rounded overflow-hidden bg-white'
            aria-label="Sidebar"
        >
            <CheckCookie />
                ...
                <div className="flex-1 flex flex-col pt-5 pb-4 overflow-y-auto">
                    <div className="flex-1 px-3 divide-y space-y-1">
                        <ul className="space-y-2 pb-2">
                            ...
                            <li>
                                <div className="rounded-lg flex items-center justify-center p-2 hover:bg-gray-100 group">
                        ...
                        <div className="space-y-2 pt-2">
                            <a href="" className="text-base text-gray-900 font-normal rounded-lg hover:bg-gray-100 group transition duration-75 flex items-center p-2">
                                ...
                                <span className="ml-4  hidden md:block">Upgrade to Pro</span>
                            </a>
                    ...
                    <div className="px-3 divide-y space-y-2">
                        ...
                        <div className="cursor-pointer text-base text-gray-900 font-normal rounded-lg flex items-center p-2 hover:bg-gray-100 group">
                            <IoMoon className="w-6 h-6 text-gray-500 group-hover:text-gray-900 transition duration-75" />
                            <span className="ml-3 hidden md:block">
                                <button onClick={changeDarkmode}>Light Mode</button>
                            </span>
                        </div>
                        <div className="cursor-pointer text-base text-white font-normal rounded-lg flex items-center p-2 bg-purple-900 hover:bg-purple-100 group">
                            <IoLogOut className="w-6 h-6 text-white group-hover:text-purple-600 transition duration-75" />
